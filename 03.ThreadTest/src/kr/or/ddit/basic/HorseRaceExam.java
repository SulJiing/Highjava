...
public class HorseRaceExam {
	...
	public static List<Horses> horseList;

	public static void main(String[] args) {
		
		// 고정된 크기의 리스트 객체 생성하기
		horseList = Arrays.asList(new Horses("01번말"), new Horses("02번말"), new Horses("03번말"), new Horses("04번말"),
				new Horses("05번말"), new Horses("06번말"), new Horses("07번말"), new Horses("08번말"), new Horses("09번말"),
				new Horses("10번말"));
	...
	public void run() {
		...
		while (true) {
			...
			for (int i = 0; i < HorseRaceExam.horseList.size(); i++) {
				...
				String horseCourse = "--------------------------------------------------"; // 50구간
				Horses horse = HorseRaceExam.horseList.get(i);
