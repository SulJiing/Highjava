...
public class T02ClassMetadataTest {
	public static void main(String[] args) {
		...
		System.out.println("샘플를래스명 : "+clazz.getSimpleName());
		System.out.println("를래스명 : "+clazz.getName());
		System.out.println("상위를래스명 : "+clazz.getSuperclass().getName());
		
		// 패키지 정보 가져오기
		Package pkg = clazz.getPackage();
		System.out.println("패키지 정보 : "+pkg.getName());
		
		// 행당 클래스에서 구현하고 있는 인터페이스목록 가져오기
